...
class ListSearchAppBar extends ConsumerStatefulWidget {
  const ListSearchAppBar({super.key});

  @override
  ConsumerState<ListSearchAppBar> createState() => _ListSearchState();
}

class _ListSearchState extends ConsumerState<ListSearchAppBar> {
  @override
