...
import 'package:flow_music/domain/implements/data/data_imp.dart';
...
class GeneralImplement extends GenealRepo {
  ...
  @override
  UserImp get userRepository => UserImplement(
      firebaseRepo: AuthFireService(), dataRepository: dataRepository);
  ...
  @override
  DataRepo get dataRepository => DataImp(data: DatabaseFirestore());
}
