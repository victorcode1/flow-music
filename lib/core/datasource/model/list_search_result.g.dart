...
) => <String, dynamic>{'musicShelfRenderer': instance.musicShelfRenderer};
...
_AccessibilityData _$AccessibilityDataFromJson(Map<String, dynamic> json) =>
    _AccessibilityData(label: json['label'] as String?);

Map<String, dynamic> _$AccessibilityDataToJson(_AccessibilityData instance) =>
    <String, dynamic>{'label': instance.label};

_Icon _$IconFromJson(Map<String, dynamic> json) =>
    _Icon(iconType: json['iconType'] as String?);
...
_$MenuNavigationItemRendererNavigationEndpointFromJson(
  ...
  modalEndpoint: json['modalEndpoint'] == null
      ? null
      : ModalEndpoint.fromJson(json['modalEndpoint'] as Map<String, dynamic>),
  browseEndpoint: json['browseEndpoint'] == null
      ? null
      : BrowseEndpoint.fromJson(json['browseEndpoint'] as Map<String, dynamic>),
...
_TitleRun _$TitleRunFromJson(Map<String, dynamic> json) =>
    _TitleRun(text: json['text'] as String?);
...
Map<String, dynamic> _$ModalEndpointToJson(_ModalEndpoint instance) =>
    <String, dynamic>{'modal': instance.modal};
...
_Modal _$ModalFromJson(Map<String, dynamic> json) => _Modal(
  modalWithTitleAndButtonRenderer:
      ...
      : ModalWithTitleAndButtonRenderer.fromJson(
          json['modalWithTitleAndButtonRenderer'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ModalToJson(_Modal instance) => <String, dynamic>{
  'modalWithTitleAndButtonRenderer': instance.modalWithTitleAndButtonRenderer,
};
...
_Button _$ButtonFromJson(Map<String, dynamic> json) => _Button(
  buttonRenderer: json['buttonRenderer'] == null
      ? null
      : ButtonRenderer.fromJson(json['buttonRenderer'] as Map<String, dynamic>),
);
...
_ButtonRendererNavigationEndpoint _$ButtonRendererNavigationEndpointFromJson(
  ...
  signInEndpoint: json['signInEndpoint'] == null
      ? null
      : SignInEndpoint.fromJson(json['signInEndpoint'] as Map<String, dynamic>),
);
...
_PurpleWatchEndpoint _$PurpleWatchEndpointFromJson(
  ...
  loggingContext: json['loggingContext'] == null
      ? null
      : LoggingContext.fromJson(json['loggingContext'] as Map<String, dynamic>),
  watchEndpointMusicSupportedConfigs:
      json['watchEndpointMusicSupportedConfigs'] == null
      ? null
      : WatchEndpointMusicSupportedConfigs.fromJson(
          json['watchEndpointMusicSupportedConfigs'] as Map<String, dynamic>,
        ),
);
...
Map<String, dynamic> _$LoggingContextToJson(_LoggingContext instance) =>
    <String, dynamic>{'vssLoggingContext': instance.vssLoggingContext};
...
Map<String, dynamic> _$VssLoggingContextToJson(_VssLoggingContext instance) =>
    <String, dynamic>{'serializedContextData': instance.serializedContextData};
...
_PlaylistItemData _$PlaylistItemDataFromJson(Map<String, dynamic> json) =>
    _PlaylistItemData(videoId: json['videoId'] as String?);
...
Map<String, dynamic> _$BackgroundToJson(_Background instance) =>
    <String, dynamic>{'verticalGradient': instance.verticalGradient};
...
Map<String, dynamic> _$VerticalGradientToJson(_VerticalGradient instance) =>
    <String, dynamic>{'gradientLayerColors': instance.gradientLayerColors};
...
_$MusicResponsiveListItemRendererThumbnailFromJson(Map<String, dynamic> json) =>
    _MusicResponsiveListItemRendererThumbnail(
...
_MusicShelfDividerRenderer _$MusicShelfDividerRendererFromJson(
  Map<String, dynamic> json,
) => _MusicShelfDividerRenderer(hidden: json['hidden'] as bool?);
...
_$ChipCloudChipRendererNavigationEndpointFromJson(Map<String, dynamic> json) =>
    _ChipCloudChipRendererNavigationEndpoint(
      clickTrackingParams: json['clickTrackingParams'] as String?,
...
_StyleClass _$StyleClassFromJson(Map<String, dynamic> json) =>
    _StyleClass(styleType: json['styleType'] as String?);

Map<String, dynamic> _$StyleClassToJson(_StyleClass instance) =>
    <String, dynamic>{'styleType': instance.styleType};
